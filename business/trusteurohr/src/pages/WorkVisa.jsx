    ...
    <main className="pt-24 lg:pt-32 pb-16 min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 md:px-12">
        ...
        >
          ...
          <div className="mb-6">
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold text-brand-navy font-serif">Working Visa</h1>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 mt-8 sm:mt-12">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-brand-navy mb-3 sm:mb-4">Secure Your Future in Europe</h2>
