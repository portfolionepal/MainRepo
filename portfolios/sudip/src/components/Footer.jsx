        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#1877F2] hover:bg-gray-100 transition-colors shadow-sm group">
              ...
              <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#0A66C2] hover:bg-gray-100 transition-colors shadow-sm group">
              ...
              <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#E4405F] hover:bg-gray-100 transition-colors shadow-sm group">
              ...
              <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-[#FF0000] hover:bg-gray-100 transition-colors shadow-sm group">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-sm text-gray-300">123 Corporate Ave, Suite 400<br/>Business District, City 10001</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-sm text-gray-300">hello@sudeepbasnet.com</span>
              </li>
            </ul>
          </div>
