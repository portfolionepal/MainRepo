...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-4">
      ...
      {/* Welcome Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-white p-10 mb-10 text-gray-800 shadow-sm border border-gray-100">
        <div className="relative z-10">
          ...
          <p className="text-gray-500 text-lg max-w-xl">
            Manage the content of your website quickly and easily with our
            dynamic CMS engine.
          </p>
        </div>
      </div>
