...
export default function About() {
  ...
  return (
    <div className="relative min-h-screen bg-[#F5F5F5] flex items-center pt-20 overflow-hidden">
      ...
      {/* Image panel (right) */}
      <div className="absolute top-20 right-0 w-full lg:w-[63%] h-[calc(100vh-5rem)] overflow-hidden bg-[#e5e1d8]">

        {/* Real photo: fills panel edge-to-edge, anchored to top so the head/face never gets cropped */}
