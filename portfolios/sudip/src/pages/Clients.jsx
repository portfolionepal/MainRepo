    ...
    <div className="py-24 bg-surface min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedSection className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-3xl lg:text-4xl font-serif font-bold text-primary mb-6">Trusted Across Industries</h2>
          <p className="text-xl text-gray-600 leading-relaxed">
            We are proud to have partnered with some of the most forward-thinking organizations, 
            helping them transform their teams, boost performance, and achieve exceptional results.
          </p>
        </AnimatedSection>
