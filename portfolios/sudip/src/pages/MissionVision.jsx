...
export default function MissionVision() {
  const values = [
    { title: 'Excellence', desc: 'We deliver nothing but the highest standard in every session.', icon: <Zap className="w-8 h-8 text-accent" /> },
    { title: 'Empathy', desc: 'Understanding the human element is at the core of all our coaching.', icon: <Heart className="w-8 h-8 text-accent" /> },
    { title: 'Integrity', desc: 'We maintain absolute confidentiality and ethical standards.', icon: <Shield className="w-8 h-8 text-accent" /> },
    { title: 'Growth', desc: 'We are committed to continuous learning and adaptation.', icon: <TrendingUp className="w-8 h-8 text-accent" /> }
  ];
    ...
    <div className="bg-surface min-h-screen">
      ...
      <div className="relative pt-32 pb-24 bg-[#1A2634] text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            <h1 className="text-5xl md:text-6xl font-serif font-bold text-white mb-6">Mission, Vision & Values</h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              The foundational principles that drive our coaching and training philosophy.
            </p>
          </AnimatedSection>
        </div>
      </div>
      ...
      <div className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
          <AnimatedSection>
            <div className="bg-white p-12 rounded-[40px] shadow-sm border border-gray-100 h-full relative overflow-hidden group hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                To empower individuals and organizations to unlock their highest potential through transformative coaching, practical NLP techniques, and highly engaging training experiences. We exist to turn potential into performance.
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.2}>
            <div className="bg-white p-12 rounded-[40px] shadow-sm border border-gray-100 h-full relative overflow-hidden group hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                To be the leading catalyst for corporate and personal transformation in Nepal and beyond, creating a future where every leader is a coach, and every workplace thrives on empathy, accountability, and continuous growth.
              </p>
            </div>
          </AnimatedSection>
        </div>
        ...
        <AnimatedSection className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            These values are not just words on a page; they are the standard by which we operate every single day.
          </p>
        </AnimatedSection>
