          ...
          <AnimatedSection>
            <div className="bg-[#FCFFF5] rounded-[30px] p-10 lg:p-12 text-gray-900 h-full shadow-xl border border-gray-100">
              ...
              <div className="flex gap-4 mb-12">
                <a href={content.facebookUrl} className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-100 text-[#1877F2] hover:bg-gray-100 transition-colors group">
                ...
                <a href={content.linkedinUrl} className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-100 text-[#0A66C2] hover:bg-gray-100 transition-colors group">
                ...
                <a href={content.twitterUrl} className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-100 text-[#1DA1F2] hover:bg-gray-100 transition-colors group">
                ...
                <a href={content.instagramUrl} className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-100 text-[#E1306C] hover:bg-gray-100 transition-colors group">
                ...
                <a href={content.youtubeUrl} className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-gray-100 text-[#FF0000] hover:bg-gray-100 transition-colors group">
          ...
          <AnimatedSection delay={0.2} className="py-6">
            ...
            <form className="space-y-6">
              ...
              <div className="relative">
                <select className="w-full bg-[#F5F7F6] border-0 rounded-xl px-6 py-4 text-gray-500 appearance-none focus:ring-2 focus:ring-[#0B7A38] outline-none transition-all">
                  <option>Manager as a Coach</option>
                  <option>Leadership Development</option>
                  <option>Let's Play Sales</option>
                  <option>Together We Can</option>
                  <option>Yes, I Can Do It!</option>
              ...
              <button
                type="submit"
                className="bg-[#0B7A38] text-white font-semibold px-8 py-4 rounded-full hover:bg-[#09632d] transition-colors shadow-lg shadow-green-900/20"
              >
                Submit request
              </button>
            </form>
